...
from bot.management import cmd_addcompany, cmd_groups
from bot.fleet import cmd_truck
from bot.fuel_costs import handle_fuelcost_text
from bot.maintenance import handle_maintenance_text
from bot.routes import handle_route_text
from bot.ai import cmd_ai_answer
...
async def handle_text(update, context):
    ...
    # ── Add Company wizard step 2: api key ──────────────────────────
        ...
        if not api_key or len(api_key) < 10:
            ...
            return
        from bot.keyboards import skip_name_kb
    ...
    elif pending.startswith("wsched_"):
        context.user_data["_pending"] = pending  # restore for handler
        from bot.work_schedules import handle_wsched_text
        await handle_wsched_text(update, context)
