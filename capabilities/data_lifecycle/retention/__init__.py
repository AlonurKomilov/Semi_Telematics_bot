...
_CONTRIBUTORS = (
    ...
    "features.inventory.retention",  # owns vehicles.inventory_events (accountability trail)
    ...
    "system.security.retention",   # owns security.requests (refusal ledger + monitored timelines)
