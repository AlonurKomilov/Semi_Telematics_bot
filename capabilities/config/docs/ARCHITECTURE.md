...
| Scorecard rules + pillar caps | `features/scorecards/config.py` + `/scorecard-rules` page | scorecards' own rows | `can_manage_config_all` (owner seeded; route/nav additionally module-masked safety/hr via featureCatalog) |
