    ...
    <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex items-end gap-3">
                ...
                <button onClick={handleConnectBot} disabled={botSaving || botToken.length < 30}
                  className="px-4 py-2 bg-primary text-primary-foreground hover:bg-primary-hover disabled:opacity-50 rounded text-sm font-medium transition whitespace-nowrap min-h-tap">
      ...
      <Card render={<section />}>
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={() => setShowSchedule(!showSchedule)} className="px-3 py-1.5 bg-primary text-primary-foreground hover:bg-primary-hover rounded text-xs font-medium transition min-h-tap">
