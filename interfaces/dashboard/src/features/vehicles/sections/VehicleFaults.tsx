    ...
    <Card>
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          ...
          disabled={diagnosing}
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-lg bg-primary/15 hover:bg-primary/25 text-foreground font-medium transition-colors disabled:opacity-60 min-h-tap ring-1 ring-primary"
        >
          {diagnosing ? (
            <>
