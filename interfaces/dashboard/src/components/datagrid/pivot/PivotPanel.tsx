                ...
                trailing={(
                  ...
                  >
                    <button
                      ...
                      className="inline-flex items-center justify-center min-w-tap shrink-0 p-1 rounded text-muted-foreground hover:text-foreground hover:bg-muted transition-colors min-h-tap"
                    >
    ...
    >
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 text-xs transition-colors hover:bg-muted/50">
        ...
        <button
          ...
          className="inline-flex items-center justify-center min-w-tap shrink-0 p-1 -ml-1 rounded cursor-grab active:cursor-grabbing text-muted-foreground/60 hover:text-foreground hover:bg-muted transition-colors touch-none min-h-tap"
        >
