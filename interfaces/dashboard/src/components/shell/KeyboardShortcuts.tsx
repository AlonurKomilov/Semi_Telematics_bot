...
export default function KeyboardShortcuts({ onOpenSearch }: KeyboardShortcutsProps) {
  ...
  const shortcuts: ShortcutDef[] = [
    ...
    { keys: 'g v', label: 'Go to Vehicles', href: '/fleet/vehicles' },
    { keys: 'g m', label: 'Go to Live map', href: '/fleet/map' },
    { keys: 'g a', label: 'Go to Alerts', href: '/safety/alerts' },
    { keys: 'g s', label: 'Go to Scorecards', href: '/safety/scorecards' },
