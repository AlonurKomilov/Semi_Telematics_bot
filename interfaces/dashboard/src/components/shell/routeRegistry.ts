...
export const ROUTE_ENTRIES: RouteEntry[] = [
  ...
  { label: 'Cameras',           path: '/cameras',    icon: Camera,        group: 'Safety', permission: ['can_view_cameras'],
  ...
  { label: 'Fuel Costs',    path: '/costs/fuel',            icon: Fuel,       group: 'Reports', permission: ['can_view_fuel_cost'],
    description: 'Fuel spend per vehicle and per mile', keywords: ['fuel','spend','cost'] },
  { label: 'Cost per Mile', path: '/costs/cpm',             icon: DollarSign, group: 'Reports', permission: ['can_view_cost_per_mile'],
  ...
  { label: 'Driver Pay',      path: '/driver-pay',          icon: DollarSign,    group: 'Workforce', permission: ['can_manage_driver_pay'],
  ...
  { label: 'Work Orders', path: '/work-orders', icon: Receipt, group: 'Fleet',
    permission: ['can_view_work_orders'],
  ...
  { label: 'Carrier Directory', path: '/workforce/carrier-directory', icon: Building2, group: 'Workforce',
    permission: ['can_view_carrier_directory'],
