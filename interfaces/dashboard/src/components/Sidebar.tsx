...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'AI Assistant',          path: '/ai/chat',               icon: '🤖', permission: null },
      { label: 'Reports',                 path: '/reports',               icon: '📄', permission: null },
      { label: 'Report Subscriptions',    path: '/reports/subscriptions', icon: '📬', permission: null },
  ...
  },
  {
    ...
    items: [
      { label: 'Driver Scorecards',  path: '/safety/scorecards', icon: '🏆', permission: ['can_scorecard_all', 'can_scorecard_own'] },
      ...
      { label: 'Cost per Mile', path: '/costs/cpm',         icon: '💰', permission: ['can_cost_per_mile'] },
    ],
  },
  {
    title: 'Admin',
    items: [
      { label: 'Team Management',        path: '/admin/users',       icon: '👥', permission: ['can_manage_users'] },
      { label: 'Role Permissions', path: '/admin/permissions', icon: '🔐', permission: ['can_manage_account'] },
      ...
      { label: 'Working Hours',    path: '/admin/work-hours',  icon: '🕐', permission: ['can_manage_account'] },
      { label: 'Billing & Plan',    path: '/admin/billing',     icon: '💳', permission: ['can_manage_billing'] },
    ],
  },
];
