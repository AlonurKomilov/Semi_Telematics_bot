/**
 * SafetyShell — wrapper for the Safety persona.
 *
 ...
 * in ``safetyNav`` (Safety-emphasized sidebar: Scorecards/Events/
 * Cameras/Alerts up top) and Phase 4 will add a Safety hero (recent
 * events feed strip, top scoring drops) above the main column.  Until
 * those phases land the only difference between this shell and
 * DefaultShell is the file you're editing — which is the point:
 * future Safety-only changes go HERE without touching the shared
 * shell.
 */
