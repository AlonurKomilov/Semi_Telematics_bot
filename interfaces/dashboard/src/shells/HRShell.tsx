/**
 * HRShell — wrapper for the HR persona.
 *
 * Same chrome (sidebar + topbar + content frame) as DefaultShell;
 * the difference is the sidebar's nav config, which uses ``hrNav``
 * (people-management emphasised).  No persona hero strip — that's
 * product work for later (HR's natural hero chips would be open
 * coaching count + driver-doc expiries + CSA inspections this week).
 * Until the hero is designed, the shell renders DefaultShell's
 * two-zone topbar layout.
 */
