"""vehicle.timeline + health + faults storage — the state stream's SQL.

Live state, minute snapshots, the hour/day/week tiers, engine-health
and DTC snapshots/detail, odometer readers and velocity windows.
...
class VehiclesWarehouseMixin(_MixinBase):
