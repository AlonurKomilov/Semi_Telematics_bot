...
class DriverPayMixin(_MixinBase):
    ...
    # driver_deductions table is DEPRECATED — deductions now flow through
    # load_line_items (bucket='deduction'), one unified mechanism.  The
    # table is left dormant (no destructive migration); its net_cents /
