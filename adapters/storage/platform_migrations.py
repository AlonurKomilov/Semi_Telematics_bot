...
async def migrate_suite_board(conn) -> None:
    ...
    try:
        ...
        for ddl in (
            "CREATE INDEX IF NOT EXISTS idx_suite_packages_run ON suite_packages(run_id)",
            "CREATE INDEX IF NOT EXISTS idx_suite_packages_name ON suite_packages(package, run_id DESC)",
