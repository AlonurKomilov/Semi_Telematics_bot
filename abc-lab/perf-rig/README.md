...
```bash
python3 abc-lab/perf-rig/rig_server.py     # scratch PG + seeded API :8010
node abc-lab/perf-rig/rig_front.js         # dist/ + /api proxy    :8020
node abc-lab/perf-rig/measure.js           # 3× at 1× CPU, 3× at 4× CPU
```
