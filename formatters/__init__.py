...
so existing ``from formatters import X`` statements keep working.
"""

# ── trucks ────────────────────────────────────────────────────────
from formatters.trucks import format_truck_detail, format_truck_picker

# ── faults ────────────────────────────────────────────────────────
from formatters.faults import format_new_fault_alert, format_critical_fault_alert

# ── health ────────────────────────────────────────────────────────
from formatters.health import format_health_alert, format_vehicle_health

# ── fuel ──────────────────────────────────────────────────────────
from formatters.fuel import format_low_fuel, format_low_fuel_alert

# ── efficiency ────────────────────────────────────────────────────
from formatters.efficiency import format_fleet_efficiency

# ── weather ───────────────────────────────────────────────────────
from formatters.weather import format_fleet_weather
...
from formatters.registration import (
    format_help,
...
# ── account / team ────────────────────────────────────────────────
from formatters.account import format_account_info, format_users_list
