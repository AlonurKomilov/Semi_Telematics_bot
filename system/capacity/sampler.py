...
# The reader moved down to capabilities.data_lifecycle.heartbeat — see
# there for why. Re-exported so the console and the capacity router keep
# one import; nothing below the system layer imports THIS name.
from capabilities.data_lifecycle.heartbeat import bot_heartbeat_age_min  # noqa: E402,F401
