...
from ai.registry import (                                   # noqa: F401
    MODEL_REGISTRY,
    MODEL_PRICING,
    DEFAULT_MODEL,
    DEFAULT_LOCATION,
...
# ── cache (no deps) ─────────────────────────────────────────────
from ai.cache import (                                       # noqa: F401
    _response_cache,
    _CACHE_TTL,
    _CACHE_MAX,
    _cache_key,
...
from ai.models import (                                      # noqa: F401
    _account_models,
...
from ai.probing import (                                     # noqa: F401
    probe_model_availability,
)

# ── generation (depends: registry, cache, chat, models) ─────────
from ai.generation import (                                  # noqa: F401
    generate,
...
def __getattr__(name: str):
    if name == "_model":
        from ai import models as _m
        return _m._model
    if name == "_last_usage":
        from ai import generation as _g
