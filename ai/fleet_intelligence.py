...
from ai.registry import _is_openai_compat
...
from ai.tools import (  # noqa: E402,F401
    execute_tool as _execute_tool,
    get_cached_vertex_tools as _get_cached_tools,
    FLEET_TOOLS,  # backward compat re-export
)
from permissions import TOOL_PERMISSIONS, ACCOUNT_WIDE_TOOLS, TRUCK_SPECIFIC_TOOLS
...
async def build_fleet_context(account_id: int,
    ...
    """
    from bot.config import get_client, get_tenant_db
            ...
            for _round in range(3):
                ...
                if part.function_call:
                    ...
                    if user_role:
                        ...
                        # Driver truck isolation: drivers can only query their own trucks
