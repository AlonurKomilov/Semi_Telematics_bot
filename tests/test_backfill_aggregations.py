...
async def test_aggregate_hour_window_accepts_arbitrary_hour():
    ...
    from capabilities.telemetry.ingestor import _aggregate_hour_window
...
async def test_aggregate_day_window_accepts_arbitrary_day():
    from capabilities.telemetry.ingestor import _aggregate_day_window
...
async def test_m5_backfill_calls_aggregations_on_success(monkeypatch):
    ...
    from capabilities.telemetry import history_backfill, ingestor
